(function(window, document, undefined) { (function(factory) {
    ...
    var DataTable = function(oInit) {
        ...
        function _fnGatherData(oSettings) {
            ...
            if (oSettings.bDeferLoading || oSettings.sAjaxSource === null) {
                ...
                while (nTr) {
                    if (nTr.nodeName.toUpperCase() == "TR") {
                        ...
                        nTd = nTr.firstChild;
                        jInner = 0;
                        // 这里计算所有列数，如果这里没有把页面默认不显示的计算进去，则绘制表格的时候会出错。
                        while (nTd) {
            ...
            // 这里统计的TD标签的数量是（每条记录显示列数 + 1） * 记录数，默认为(8 + 1) * n 
            nTds = [];
        ...
        function _fnGetTrNodes(oSettings) {
            ...
            for (var i = 0, iLen = aoData.length; i < iLen; i++) {
                /*if(aoData[i].nTr.getAttribute("class") === "default_hiden_record_info"){
                    console.log(aoData[i].nTr);
                    continue;
                }*/
    ...
    // 页面加载时oSettings里面的aoData就包括了所有的记录数据
    DataTable.models.oSettings = {
        "oFeatures": {
            "bAutoWidth": null,
            "bDeferRender": null,
